...
🔗 **[ツールを使う](https://freezingdragon.github.io/cnc_webcam/cnc-cam.html)**

---

## 概要

Genmitsu 3018Pro / 3040（GRBL）向けに最適化された軽量CAMツールです。DXFファイルをブラウザにドロップするだけで切削用Gコードを生成します。サーバー不要、インストール不要、HTMLファイル1枚で完結します。
...
- **バウンディングボックストレース** — 加工前の範囲確認用Gコードを別途生成
...
1. **[ツールを開く](https://freezingdragon.github.io/cnc_webcam/cnc-cam.html)**
